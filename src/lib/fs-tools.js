...
const postCoverPath = join(dirname(fileURLToPath(import.meta.url)), "../../public/img/cover");
...
export const readPostCover = (fileName) => createReadStream(join(postCoverPath, fileName));

export const getAuthorsSource = () => createReadStream(join(dataFolderPath, "authors.json"));

export const getPostsSource = () => createReadStream(join(dataFolderPath, "blogPosts.json"));
